...
public final class AExponentiationExpression extends PExpression
{
    private PExpression _lpar_;
    private PExpression _rpar_;

    public AExponentiationExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AExponentiationExpression(
    ...
    {
        ((Analysis) sw).caseAExponentiationExpression(this);
    }
